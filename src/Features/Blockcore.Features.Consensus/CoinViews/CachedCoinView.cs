...
namespace Blockcore.Features.Consensus.CoinViews
{
    ...
    public class CachedCoinView : ICoinView
    {
        ...
        /// <inheritdoc />
        public void SaveChanges(ICollection<UnspentOutput> outputs, HashHeightPair oldBlockHash, HashHeightPair nextBlockHash, List<RewindData> rewindDataList = null)
        {
